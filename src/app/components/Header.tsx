        ...
        {contas.length > 0 && (
          <div className="relative hidden md:block">
            <button
              ...
              className="flex items-center gap-2 bg-[#29292e] hover:bg-[#323238] transition-colors px-4 py-2 rounded-lg text-[#c4c4cc] text-sm"
            >
              ...
              <div className="absolute left-0 top-full mt-2 bg-[#29292e] rounded-lg shadow-lg min-w-[220px] z-50">
                {contas.map((c) => (
                  <button
                    ...
                    className={`w-full text-left px-4 py-3 text-sm hover:bg-[#323238] transition-colors first:rounded-t-lg ${
                ...
                <button
                  ...
                  className="w-full text-left px-4 py-3 text-sm text-[#00b37e] hover:bg-[#323238] transition-colors rounded-b-lg flex items-center gap-2 border-t border-[#323238]"
                >
