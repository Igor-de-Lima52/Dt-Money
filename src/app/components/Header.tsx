...
export default function Header() {
  ...
  return (
    <header className="w-full px-6 py-10 fixed md:relative md:px-12 lg:px-30 md:pt-10 md:pb-30 bg-[var(--background)] flex items-center justify-between">
      <Image src="/logo.svg" alt="Logo" width={200} height={50} loading="eager" className="w-auto h-8 md:h-auto" />
      <div className="flex md:items-center gap-4">
        <button
          // onClick={onNewTransaction}
          className="cursor-pointer bg-[#00875f] hover:bg-[#015f43] transition-colors content-stretch flex items-center justify-center overflow-clip px-3 py-2 md:px-5 md:py-3 rounded-lg shrink-0"
        >
        ...
        <div className="relative z-50">
          ...
          {showProfileMenu && (
            <div className="z-50 absolute right-0 top-full mt-2 bg-[#29292e] rounded-lg shadow-lg min-w-[190px]">
              <Link href="/profile">
