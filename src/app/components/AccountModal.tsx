      ...
      >
        <div className="p-8 md:p-10">
          <div className="flex items-start justify-between mb-8">
            ...
            <button onClick={onClose} className="cursor-pointer text-[#7c7c8a] hover:text-[#c4c4cc] transition-colors ml-4 shrink-0">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                  ...
                  <div className="relative flex items-center">
                    {isOpenDropdown ? (
                      ...
                      <button
                        ...
                        className="cursor-pointer w-full bg-[#121214] rounded-[6px] px-4 py-4 pr-14 text-[#e1e1e6] text-left border border-transparent focus:outline-none focus:ring-2 focus:ring-[#00b37e] transition-all"
                      >
                        ...
                        {sortedFilteredBancos.length === 0 ? (
                          ...
                          sortedFilteredBancos.map((b) => (
                            <button
                              ...
                              className={`cursor-pointer w-full text-left px-4 py-3 text-sm transition-colors cursor-pointer flex items-center justify-between ${
                                b.id === bancoId
            ...
            <button
              ...
              className="cursor-pointer w-full bg-[#00875f] hover:bg-[#015f43] transition-colors text-white font-bold py-4 rounded-[6px] mt-2 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              {saving ? (
                <>
