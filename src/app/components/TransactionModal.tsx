          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <div className="flex gap-4">
              <button
                ...
                className={`cursor-pointer flex-1 flex items-center justify-center gap-2 px-4 py-4 rounded-[6px] transition-colors border-2 ${
                  type === "income"
            ...
            <button
              type="submit"
              disabled={saving}
              className="cursor-pointer w-full bg-[#00875f] hover:bg-[#015f43] transition-colors text-white font-bold py-4 rounded-[6px] mt-2 disabled:opacity-50 flex items-center justify-center gap-2"
            >
              {saving ? (
